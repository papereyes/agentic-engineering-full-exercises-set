...
4. When a change is publishable, read [references/evidence-policy.md](references/evidence-policy.md). If records are absent, say so and never claim tests passed.
